...
public class AnalizadorARM implements AnalizadorARMConstants {
  ...
  final public Token valor2(String tipoEsperado) throws ParseException {
                                     Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ENTEROS:
  ...
  final public void condicion(String labelElse) throws ParseException {
                                    Token t1,t2,op;
    try {
      t1 = valor2(labelElse);
  ...
  final public Token OperadoresComparadores() throws ParseException {
                                  Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IGUALDAD:
  ...
  final public String operacionParentesis(String type) throws ParseException {
                                          String t;
    try {
      jj_consume_token(PARENIZQ);
  ...
  final public Token operadorAritmeticoMasMenos() throws ParseException {
                                     Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MAS:
  ...
  final public Token operadorAritmeticoMulDiv() throws ParseException {
                                   Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MULT:
  ...
  final public String Factor(String type) throws ParseException {
                              Token t; String t1;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ENTEROS:
    case NUMERODECIMAL:
  ...
  final public void inicializarArregloEntero() throws ParseException {
                                   Token t, t1, ta; int cantidadValores = 0; int tamanio;
    try {
  ...
  final public void inicializarArregloCadena() throws ParseException {
                                   Token t, t1, ta; int tamanio, cantidadValores = 0;
    try {
  ...
  final public int ValoresEntero(int cantidadValores) throws ParseException {
    ...
    default:
     ...
     {if (true) return cantidadValores;}
    throw new Error("Missing return statement in function");
  }
